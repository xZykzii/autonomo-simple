/* =========================================================================
   ESPAÑA — sección /es/
   Se carga DESPUÉS de config.js. Aquí viven las cifras del RETA y los
   bloques de monetización de la versión española.
   Esta sección está en mantenimiento: el foco del sitio es Chile.
   ========================================================================= */
...
/* -------------------------------------------------------------------------
   DATOS FISCALES DE LAS CALCULADORAS (España)
